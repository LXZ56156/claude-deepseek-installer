...
**A:** 重新双击「00-点我开始安装.cmd」，选择 [1] 一键安装，脚本会检测已有版本并询问是否更新。

### Q28: 换了电脑怎么办？
**A:** 重新在新电脑上运行「00-点我开始安装.cmd」即可。需要重新配置 API Key。
...
4. 也可以从「00-点我开始安装.cmd」→ 选择 [4] 高级选项 → [2] 配置 WSL
