...
- **Status**: VM acceptance final closure implemented on host: transactional resume registration/cleanup, strict SchemaVersion 3 prefix validation, UTF-8 ConPTY driver, static machine-state guard, transactional final summary, isolated TestSafe release output, 112 functional checks pass, and 16 TestSafe interactive scenarios pass. Dedicated VM Live and real reboot remain pending.
