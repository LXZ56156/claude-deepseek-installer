...
- **Status**: Resume hardening follow-up implemented: fail-closed task deletion, SchemaVersion 3 gate, stale checkpoint removal, and executable resume control-flow test. Dedicated VM Live and real reboot remain pending.
